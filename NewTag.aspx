                ...
                <div class="modal-content" style="width: 500px">
                    ...
                    <div class="modal-body" style="padding-top: 0px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-5" style="padding-left: 0px; padding-right: 0px; padding-top: 5px;float:left;">
                                <span id="btnTagSearch" style="border-width: 0px; border-style: none; background-color: white; color: grey;padding-right : 12px;padding-left : 2px;"><i class="fas fa-search"></i></span>
                                <button id="btnAddTag" onclick="javascript:addTag();return false;" class="disabledaddTagtoListButton"> <i class="fas fa-plus" ></i> ADD TO TAG LIST</button>
                            </div>
                        </div>
                        ...
                        if (data.d != null) {
                            ...
                            $.each(templstAllTags, function (key, val) {
                                ...
                                if (val.IsChecked === 1) {
                                    ...
                                    parentDiv += '<div  RoleId=' + u.Role + ' id = ' + btnId + ' tagid = "' + val.TAG_ID + '" tagname = "' + val.TAG_LABEL + '" class="tagellipsisbutton" style = "height:100%;width:7px;float:left;cursor:pointer;padding-left:6px;padding-right:10px;padding-top:5px;"><i class="fas fa-ellipsis-v" style="color: #757575;"></i></div>';
                                    parentDiv += '<div style="height:100%;padding-right:10px;float:left;padding-top:7px;font-size:11px;font-family: Roboto, sans-serif;border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick = "javascript:viewTRMEntriesModel(' + val.TAG_ID + ',false);return false;">&nbsp;&nbsp;<i class="fas fa-user-friends" style="padding-top:2px;float:left;padding-right:2px;"></i>' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
        ...
        $(document).ready(function () {
            ...
            $("#viewTRMModel").on('keydown', function (event) {
                if ((event.keyCode || event.which) == 27) {
                    ...
                    if (document.activeElement.id == lastElement) {
                        /* alert(document.activeElement.id);*/
                        document.getElementById("viewTRMModel").focus();
                        e.preventDefault();
                    }
                }
            });
