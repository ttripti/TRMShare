                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-9" style="padding-left: 30px;height:25px;">
                                ...
                                <label id="lblCreateWgTagErrorMessage" style="color: red; font-family: Roboto, sans-serif; font-weight: normal;font-size: 12px;"></label>
       ...
       function morelessFunction() {
        ...
        function addinapprTag() {
           ...
           if (lstTags.filter(x => x.TAG_LABEL.trim() === $('#txtTagName').val().trim()).length > 0) {
                if ($('#hdnSelectedWgId').val() == -1)
                    $('#spanaddEntryErrorMessage').text('Tag already exists');
                else
