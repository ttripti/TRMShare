        ...
        <div class="" id="dvNewTag">
            ...
            <div id="dvPersonalTag">
                    <div class="row">
                            ...
                            <div class="col-8" id="personalCollapse">
                    ...
                    <div class="row collapse show" id="dvrowtag" >
                        ...
                        <div class="col-8" >
                            ...
                            <button id="btnaddNewWGTag" onclick="javascript:openWgTagModel(0);return false;" class="addgrouptagsButton">
                                <i class="fas fa-tag" style="color:black"></i>&nbsp;&nbsp;&nbsp;GROUP TAGS</button>
                        </div>
                            </div>
                        ...
                        if (data.d != null) {
                            ...
                            $.each(data.d, function (key, val) {
                                ...
                                if (val.IsChecked === 1) {
                                    ...
                                    parentDiv += '<div style="display: inline-block;padding-right:10px;font-size:11px;font-family: Roboto, sans-serif;border-radius: 3px;white-space: pre-wrap;">&nbsp;&nbsp;<i class="fas fa-user-friends"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount +')' + '</div></div></div></div>';
