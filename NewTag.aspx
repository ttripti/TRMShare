...
<body>
    ...
    <form id="form1" runat="server" style="width:90%">
        ...
        <div class="" id="dvNewTag">
            ...
            <table id="tagManagementTable" cellpadding="20px"> 
            
            <tr class="tagManagementRow">
                <td>
                    <div class="row">
                     <!--   <span style="font-family: 'Roboto', sans-serif; font-size: 14px">Group Tags</span>   -->
                    <table style="width:100%;"><tr><td style="width:80%;"><div class="col-sm-5" style=" font-family: 'Roboto', sans-serif; font-size: 14px">
                        PERSONAL TAGS<%--</div>--%>
                        <%--<div class="col-sm-11">--%>
                        <button id="btnaddNewPersonalTag" onclick="javascript:openWgTagModel(54);return false;" class="addremovetagsButton">
                            <i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;PERSONAL TAGS
                        </button>
                 </td><td style="width:20%;float:right;">
                   ...
                   <div class="row collapse show" id="dvpersonnalrowtag" ></div> 
                </td>
            </tr>
            <tr class="tagManagementRow"><td>
                <div class="row">
                     <!--   <span style="font-family: 'Roboto', sans-serif; font-size: 14px">Group Tags</span>   -->
                    <table style="width:100%;"><tr><td style="width:80%;"> <div class="col-sm-4" style=" font-family: 'Roboto', sans-serif; font-size: 14px">
                        GROUP TAGS<%--</div>--%>
                        <%--<div class="col-sm-11">--%>
                        
                        <button id="btnaddNewWGTag" onclick="javascript:openWgTagModel(54);return false;" class="addremovetagsButton">
                            <i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;GROUP TAGS
                        </button></td><td style="width:20%;float:right;">
            ...
            <div class="row collapse show" id="dvrowtag" >
                <div class="col-sm-4">
                    <span style="font-family: 'Roboto', sans-serif; font-size: 14px">My Groups</span>
                    
                    <br />
                    <br />
                    <ul class="list-group" id="dvMrGroups" style="font-family: Roboto; font-size: 11px;overflow-y: auto; height: 500px;">
                    </ul>
                </div>
                <div class="col-sm-8" >
                    <div class="row">
                        <div class="col-sm-12">
                            <span style="font-family: 'Roboto', sans-serif; font-size: 14px">Group Tags - </span>
                            <span id="spanselectedGroupName" style="font-family: Roboto; font-size: 14px;white-space: pre-wrap"></span>
                        </div>
                    </div>
                    <div class="row">
                        <br />
        ...
        <div id="dvTagPopup" class="messagepop tagpop" style="display:none;width:190px; border: 1px solid #dee2e6;">
        ...
        <div style="padding-top: 5px;padding-bottom:5px;background-color:white;cursor:pointer" class="grpellipsemenu" id="dvtagTRMEntry" onclick="javascript:createTagEntryModel();return false;" >
            ...
            <div style="display:inline-block;">
                <a href="#" style="text-decoration: none; color: grey; font-size: 12px; font-family: Roboto, sans-serif;" >&nbsp;&nbsp;Tag a TRM Entry</a>
            </div>
        </div>
        ...
        <div style="padding-top: 5px;padding-bottom:5px;background-color:white;cursor:pointer" class="grpellipsemenu" id="dvRemoveTag" onclick="javascript:removeTag();return false;">
            ...
            <div style="display:inline-block;">
                <a href="#" style="text-decoration: none; color: grey; font-size: 12px; font-family: Roboto, sans-serif;" >&nbsp;&nbsp;Remove Tag from Entry</a>
            </div>
        </div>
    </div>
</div>

        <div class="modal fade" id="newToolTagModel" tabindex="-1" role="dialog" aria-labelledby="newWGTagModalLabel" aria-hidden="true">
                ...
                <div class="modal-content" style="width: 500px">
                    ...
                    <div class="modal-body" style="padding-top: 0px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3" style="text-align: center; padding-right: 0px;">
                        ...
                        <div class="row">
                            <div class="col-sm-12" id="dvWgTags" style="overflow-y: auto; height: 200px;">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <div class="row">
                            <div class="col-sm-12" style="text-align: center;">
                                <button type="button" id="btncancelsaveworkgroup" class="cancelButton" data-dismiss="modal">CANCEL</button>
    ...
    <script>
                    ...
                    if (data != null) {
                        ...
                        if (data.d != null) {
                            ...
                            $.each(data.d, function (key, val) {
                                ...
                                if (val.IsChecked === 1) {
                                    parentDiv = '';
                                    parentDiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div id=' + dvid+' style="display:inline-block;background-color:#c4dcef;border-radius:2px;padding-bottom:3px;padding-left:3px;"><div style="font-size:12px;display:inline-block;border-radius:6px;text-align:center;">';
                                    ...
                                    parentDiv += '<div style="display: inline-block;padding-right:10px;font-size:11px;font-family: Roboto, sans-serif;border-radius: 3px">&nbsp;&nbsp;&nbsp;' + val.TAG_LABEL + '</div></div></div></div>';
        ...
        function addinapprTag() {
            ...
            if (lstTags.filter(x => x.TAG_LABEL.trim() === $('#txtTagName').val().trim()).length > 0) {
                ...
                var aid = 'a' + tagId;
                var cid = 'chk' + tagId;
                var parentDiv = '<div style="text-decoration: none;font-family: Roboto;font-size:11px;padding-left:30px" class="list-group-item list-group-item-action" id="' + aid + '" ><input type="checkbox" onchange="tagChange(this)" tagid="' + tagId + '"';
        ...
        function addTag() {
            ...
            if (enteredtext.length > 0) {
                ...
                if (isapprworddetected) {
                    ...
                    var txtMsg = 'The word(s) "' + enteredtext + '" have been flagged as inappropriate. TRM Admins monitor all site activity.';
                    ...
                    if (lstTags.filter(x => x.TAG_LABEL.trim() === $('#txtNewWgTagName').val().trim()).length > 0) {
                        ...
                        $.each(newlstTags, function (key, val) {
                            ...
                            parentDiv += '<div style="text-decoration: none;font-family: Roboto;font-size:11px;padding-left:30px;" class="list-group-item list-group-item-action" id="' + aid + '" ><input type="checkbox"  onchange="tagChange(this)" tagid="' + val.TAG_ID + '"';
                            console.log(val.IsChecked);
                            if (val.IsChecked > 0) {
                                parentDiv += ' checked="checked" ';
                            }
                            parentDiv += 'class="form-check-input" id="' + cid + '"/><label style="padding-top:2px;" for="' + cid + '">&nbsp;&nbsp;' + val.TAG_LABEL + '</label></div>';
                        });
                        $('#dvWgTags').append(parentDiv);
        ...
        $(document).ready(function () {
            ...
            var parentDiv = ''; var grpId = '';
            $.each(lstWgs, function (key, val) {
                grpId = 'grp' + val.WG_ID;
                //parentDiv += '<a href="ToolPage.aspx?tid=' + val.Tool_Id + '" class="list-group-item list-group-item-action" style="color:#4169e1;font-family: Roboto;font-size:12px;">' + val.Tool_Name + '</a>'
                $('#dvMrGroups').append('<li style="cursor:pointer;white-space: pre-wrap;" class="list-group-item list-group-item-action" id="' + grpId + '" onclick="loadTagforSelectedWg(' + val.WG_ID + ');">' + val.WG_LABEL + '</li>');
                //parentDiv += '<div class="list-group">';
                //parentDiv += '<a href="#" style="text-decoration: none;font-family: Roboto;font-size:11px;" class="list-group-item list-group-item-action" id="' + aid + '" onclick="javascript:selectedTool(' + val.Tool_Id + ');return false;">' + val.Tool_Name + '</a>'
                //parentDiv += '</div>';
                //$('#dvMrGroups').append(
            ...
            $.each(lstTags, function (key, val) {
                ...
                if (val.WG_ID.toString() === $('#hdnWgId').val()) {
                    //parentDiv = '';
                    //parentDiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div style="display:inline-block;background-color:#c4dcef;border-radius:2px;padding-bottom:3px;">';
                    //parentDiv += '<div style="font-size:12px;display:inline-block;border-radius:6px;text-align:center;">';
                    //parentDiv += '<div RoleId="' + u.Role +'" id=' + btnId + ' tagid = "' + val.TAG_ID + '" tagname = "' + val.TAG_LABEL + '" class="tagellipsisbutton" style = "width:3px;display:inline-block;padding-left:3px;cursor:pointer;">';
                    //parentDiv += ' <a class="tagellipsisbutton" style="cursor: pointer; "><i class="fas fa - ellipsis - v" style="color: #757575; "></i></a></div>';
