                    ...
                    if (data != null) {
                        ...
                        if (data.d != null) {
                            ...
                            $.each(templstAllTags, function (key, val) {
                                ...
                                parentDiv += '<div id = ' + ptbtnId + ' tagid = "' + val.TAG_ID + '" tagname = "' + val.TAG_LABEL + '" class="tagellipsisbuttonpt" style = "width:7px;float:left;height:100%;cursor:pointer;padding-left:6px;padding-right:7px;padding-top:5px;"><i class="fas fa-ellipsis-v" style="color: #757575;"></i></div>';
                                parentDiv += '<div style="height:100%;float:left;padding-right:10px;padding-top:6px;font-size:11px;font-family: Roboto, sans-serif;border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick = "javascript:viewTRMEntriesModel(' + val.TAG_ID + ',true);return false;">&nbsp;&nbsp;<i class="fas fa-user"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
                        ...
                        if (data.d != null) {
                            ...
                            $.each(templstAllTags, function (key, val) {
                                ...
                                if (val.IsChecked === 1) {
                                    ...
                                    parentDiv += '<div  RoleId=' + u.Role + ' id = ' + btnId + ' tagid = "' + val.TAG_ID + '" tagname = "' + val.TAG_LABEL + '" class="tagellipsisbutton" style = "height:100%;width:7px;float:left;cursor:pointer;padding-left:6px;padding-right:7px;padding-top:5px;"><i class="fas fa-ellipsis-v" style="color: #757575;"></i></div>';
                                    parentDiv += '<div style="height:100%;padding-right:10px;float:left;padding-top:6px;font-size:11px;font-family: Roboto, sans-serif;border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick = "javascript:viewTRMEntriesModel(' + val.TAG_ID + ',false);return false;">&nbsp;&nbsp;<i class="fas fa-user-friends"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
        ...
        $(document).ready(function () {
            ...
            $.each(templstAllTags, function (key, val) {
                ...
                if (val.WG_ID.toString() === $('#hdnWgId').val()) {
                    ...
                    var dvid = 'dv' + val.TAG_ID
                    parentDiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div Id=' + dvid + ' style="display:flex;height:28px;background-color:rgb(220, 230, 250);border-radius:2px;padding-left:3px;"><div style="font-size:12px;display:inline-block;border-radius:6px;text-align:center;">';
                    parentDiv += '<div RoleId=' + u.Role + ' id = ' + btnId + ' tagid = "' + val.TAG_ID + '" tagname = "' + val.TAG_LABEL + '" class="tagellipsisbutton" style = "height:100%;width:7px;float:leftcursor:pointer;padding-left:6px;padding-right:7px;padding-top:5px;"><i class="fas fa-ellipsis-v" style="color: #757575;"></i></div>';
                    parentDiv += '<div style="height:100%;float:left;padding-right:10px;padding-top:6px;font-size:11px;font-family: Roboto, sans-serif;border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick = "javascript:viewTRMEntriesModel(' + val.TAG_ID + ',false);return false;">&nbsp;&nbsp;<i class="fas fa-user-friends"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
                    $('#dvTags').append(parentDiv);
                    gtagcounter++;
                }
