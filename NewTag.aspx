    ...
    <form id="form1" runat="server" style="width:100%">
        <div class="" id="dvNewTag">
            ...
            <div id="dvPersonalTag">
                    <div class="row">
                            <div class="col-4" style="width:80%;"><div style=" font-family: 'Roboto', sans-serif; font-size: 14px; font-weight:400">
            ...
            <div id="dvTagGroups">
                    <div class="row">
                                <div class="col-4" style="width:80%;font-family: 'Roboto', sans-serif; font-size: 14px;font-weight:400"> <div>
                                    Group Tags 
                                    </div>
                                </div>
        ...
        <div style="padding-top: 5px;padding-bottom:5px;background-color:white;cursor:pointer" class="grpellipsemenu" id="dvTagCompTech">
            <div style="padding-left: 10px;display:inline-block; color:rgb(80,80,80)">
    ...
    <script>
                    ...
                    if (data != null) {
                        ...
                        if (data.d != null) {
                            ...
                            $.each(data.d.lstAllTags, function (key, val) {
                                ...
                                parentDiv += '<div style="display: inline-block;padding-right:10px;font-size:11px;font-family: Roboto, sans-serif;border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick = "javascript:viewTRMEntriesModel(' + val.TAG_ID + ',true);return false;">&nbsp;&nbsp;<i class="fas fa-user"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
                    ...
                    if (data != null) {
                        ...
                        if (data.d != null) {
                            ...
                            if (tagCounter == 0) {
                                ...
                                parentDiv += '<div style="display: inline-block;padding-right:10px;font-size:11px;font-family: Roboto, sans-serif;"><p> No group tags for [' + groupName + '] have been applied to this entry.</p></div>';
                                $('#dvTags').append(parentDiv);
        ...
        function openWgTagModel(wgId) {
           ...
           // $('#hdnWgId').val(wgId);
            ...
            $('#lblGroupName').text(selectedGroupName.substr(selectedGroupName, selectedGroupName.indexOf('(')-1));
        ...
        $(document).ready(function () {
            ...
            if (selectedGroupName.lastIndexOf('(') == -1) {
                $('#spanselectedGroupName').text(selectedGroupName);
            }
            else if (selectedGroupName.lastIndexOf('(') > 0) {
