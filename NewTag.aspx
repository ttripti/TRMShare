...
<body>
    ...
    <form id="form1" runat="server" style="width: 100%">
        ...
        <div class="row" style="padding-top:1px;"></div>
            <div style="max-width:80%;">  
                <p style="font-size:11px;font-family: Arial;text-align:left;">Welcome to your TRM Tag Management profile. Tag Management helps you organize your collection of TRM entries in a personalized and 
                <span id="dots">...&nbsp;</span>
                <span id="more">meaningful manner. You may use this page to view and manage your personal and group tags. Here, you may easily add TRM entries to your tags within the My Personal Tags or My Group Tags sections.<br /><br />
        ...
        <div class="" id="dvTagmenu">
            <div id="dvTagPopup" class="messagepop tagpop shadow-sm mb-5 bg-white rounded" style="display: none; width: 220px; border: 1px solid #dee2e6; border-radius: 5px;">
    ...
    <script>
        ...
        function viewTRMEntriesModel(aTagID, isPersonal) {
                ...
                success: function (data, status, jqXHR) {
                    ...
                    if (data != null) {
                        ...
                        if (data.d.lstTools != null) {
                            ...
                            parentDiv += '<div class="list-group">';
                            $.each(data.d.lstTools, function (key, val) {
                                parentDiv += '<a href="ToolPage.aspx?tid=' + val.Tool_Id + '" target="_parent" class="list-group-item list-group-item-action" style="color:#4169e1;font-family: Roboto;font-size:12px;">' + val.Tool_Name + '</a>'
                            });
                            parentDiv += '</div>';
                    ...
                    if (data != null) {
                        ...
                        if (data.d != null) {
                            ...
                            $.each(templstAllTags, function (key, val) {
                                ...
                                parentDiv = '';
                                parentDiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div id=' + ptdvid + ' style="display:flex;background-color:rgb(220, 230, 250);border-radius:2px;padding-bottom:5px;padding-left:3px;height:28px;"><div style="font-size:12px;display:inline-block;border-radius:6px;text-align:center;">';
                                parentDiv += '<div id = ' + ptbtnId + ' tagid = "' + val.TAG_ID + '" tagname = "' + val.TAG_LABEL + '" class="tagellipsisbuttonpt" style = "width:7px;display:inline-block;cursor:pointer;padding-left:6px;padding-right:7px;"><i class="fas fa-ellipsis-v" style="color: #757575;"></i></div>';
                                parentDiv += '<div style="height:100%;display: inline-block;padding-right:10px;padding-top:6px;font-size:11px;font-family: Roboto, sans-serif;border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick = "javascript:viewTRMEntriesModel(' + val.TAG_ID + ',true);return false;">&nbsp;&nbsp;<i class="fas fa-user"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
                    ...
                    if (data != null) {
                        ...
                        if (data.d != null) {
                            ...
                            $.each(templstAllTags, function (key, val) {
                                ...
                                if (val.IsChecked === 1) {
                                    parentDiv = '';
                                    parentDiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div id=' + dvid + ' style="display:inline-block;background-color:rgb(220, 230, 250);border-radius:2px;padding-bottom:5px;padding-left:3px;"><div style="font-size:12px;display:inline-block;border-radius:6px;text-align:center;">';
                                    parentDiv += '<div  RoleId=' + u.Role + ' id = ' + btnId + ' tagid = "' + val.TAG_ID + '" tagname = "' + val.TAG_LABEL + '" class="tagellipsisbutton" style = "width:7px;display:inline-block;cursor:pointer;padding-left:6px;padding-right:7px;"><i class="fas fa-ellipsis-v" style="color: #757575;"></i></div>';
                                    parentDiv += '<div style="display: inline-block;padding-right:10px;font-size:11px;font-family: Roboto, sans-serif;border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick = "javascript:viewTRMEntriesModel(' + val.TAG_ID + ',false);return false;">&nbsp;&nbsp;<i class="fas fa-user-friends"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
        ...
        $(document).ready(function () {
            ...
            $.each(templstAllTags, function (key, val) {
                ...
                if (val.WG_ID.toString() === $('#hdnWgId').val()) {
                    ...
                    parentDiv = '';
                    var dvid = 'dv' + val.TAG_ID
                    parentDiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div Id=' + dvid + ' style="display:flex;height:28px;background-color:rgb(220, 230, 250);border-radius:2px;padding-bottom:5px;padding-left:3px;"><div style="font-size:12px;display:inline-block;border-radius:6px;text-align:center;">';
                    parentDiv += '<div RoleId=' + u.Role + ' id = ' + btnId + ' tagid = "' + val.TAG_ID + '" tagname = "' + val.TAG_LABEL + '" class="tagellipsisbutton" style = "width:7px;display:inline-block;cursor:pointer;padding-left:6px;padding-right:7px;"><i class="fas fa-ellipsis-v" style="color: #757575;"></i></div>';
                    parentDiv += '<div style="height:100%;display: inline-block;padding-right:10px;padding-top:6px;font-size:11px;font-family: Roboto, sans-serif;border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick = "javascript:viewTRMEntriesModel(' + val.TAG_ID + ',false);return false;">&nbsp;&nbsp;<i class="fas fa-user-friends"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
                    $('#dvTags').append(parentDiv);
                    gtagcounter++;
