            ...
            <div class="modal-content" style="width: 800px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row" style="padding-top: 10px; padding-bottom: 20px; width: 100%;height:65px;">
                        ...
                        <div class="col-6" style="display: inline-block; vertical-align: middle;padding-left:0px;">
                    ...
                    if (data != null) {
                        ...
                        if (data.d.lstTools != null) {
                            ...
                            $.each(data.d.lstTools, function (key, val) {
                                ...
                                parentDiv += '<a href="#" OnClick="javascript:openToolPage(' + val.Tool_Id + ');return false;" style="text-decoration: none !important; color:#4169e1;font-family: Roboto;font-size:12px;">' + val.Tool_Name + '</a>';
                                if (RoleId < 3 || showGrp == false) {
                                    parentDiv += '</label>'
                                }
                                parentDiv += '</div>';
