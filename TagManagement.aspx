                ...
                <td>
                    <div id="dvPersonalTag">
                        ...
                        <div class="row">
                            ...
                            <button id="btnnewpersonaltag" class="newtagbutton" onclick="javascript:openPsnlTagModel();return false;">
                    ...
                    if (data != null) {
                        ...
                        if (data.d.IsValid) {
                            ...
                            $.each(lstTags, function (key, val) {
                                ...
                                parentDiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div Id=' + dvId + ' style="display:inline-block;background-color:rgb(220, 230, 250);border-radius:2px;padding-bottom:3px;" ><div style="font-size:12px;display:inline-block;border-radius:6px;">'
                            ...
                            $('.tagellipsisbuttonpt').click(function () {
                                ...
                                if ($('#dvTagPopup').is(':visible')) {
                                    ...
                                    var top = btn1.offset().top + btn1.outerHeight() + 2;
