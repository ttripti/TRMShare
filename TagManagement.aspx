...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <% 
        ...
        If trmGlobals.fileType = "Excel" Or trmGlobals.fileType = "Word" Then
            groupId = trmCodeLib.ProcessReqParam("groupId")
            If Not (trmCodeLib.isNull(groupId)) And Not (IsNumeric(groupId)) Then
                trmCodeLib.redirectURLErrorPage(PageGlobals.urlErrorMsg)
            End If
            groupName = trmCodeLib.ProcessReqParam("groupName")
            If Not (trmCodeLib.isNull(groupName)) Then
                If Len(groupName) > 30 Then trmCodeLib.redirectURLErrorPage(PageGlobals.urlErrorMsg)
            End If
            fileName = groupName & "_Tag_Report"
            'If trmGlobals.fileType = "Excel" Then
            '    'send report to excel
            '    trmCodeLib.CreateExcelFile(fileName)
            If trmGlobals.fileType = "Word" Then
                'send report to word
                trmCodeLib.CreateWordFile(fileName)
            End If

            Call GenerateWord(groupId)
        Else
    %>
    ...
    <div id="videoModal" class="modal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="true" style="margin: auto; overflow: auto;">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 640px; height: 520px; top: -80px; left: 2px">
                <div class="modal-header border-bottom-0" style="margin-bottom: 0px; width: 630px; height: 30px">
                    <button type="button" class="close" data-dismiss="modal" onclick="closeVideoModal()" aria-label="Close" style="margin-right: 0px">
                ...
                <div style="margin-top: 0px; height: 470px">
                    ...
                    <p id="modalTitle" style="font-family: Roboto; font-size: 18px; margin-left: 79px; margin-top: -7px; font-weight: 600; height: 10px"></p>
                </div>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <a class="tagMgntVideoLinks" href="<%= tagManagementVideoLink %>" target="_blank">How to Use Tag Management in the TRM</a>-->
            <i class="fa fa-video fa-sm"></i>&nbsp;
                    ...
                    <div id="dvPersonalTag">
                        <div class="row" style="padding-top: 20px">
                            ...
                            <div class="col-1" id="personalCollapse">
                                <div aria-expanded="true" class="collapseClass" data-toggle="collapse" href="#dvWGPersonalTagsContainer" style="cursor: pointer">
                    ...
                    <div id="dvTagGroups">
                        ...
                        <button id="btnnewgroup" class="ptnewtagbutton" onclick="javascript:OpenNewGroupDialog();return false;">
                            ...
                            <div class="col-1" id="GrpCollapse">
                                <div aria-expanded="true" class="collapseClass" data-toggle="collapse" href="#dvWGTagsContainer" style="cursor: pointer">
                                    <i class="fa fa-chevron-up"></i>
                                    <i class="fa fa-chevron-down"></i>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="MembersModel" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static" aria-labelledby="membersModalLabel" aria-hidden="true">
        <div id="dvRolePopup" class="messagepop shadow-sm mb-5 bg-white roleInfoPopup infoPopUp" style="border-radius: 5px; font-family: 'Roboto', sans-serif; font-size: 10px; display: none; width: 430px; height: 375px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-9" style="padding-left: 30px; height: 25px;">
                            ...
                            <label id="lblCreateGroupErrorMessage" style="display: block; color: red; font-family: Roboto, sans-serif; font-weight: normal; padding-top: 4px; padding-left: 5px;"></label>
        ...
        <div class="modal-dialog" role="document" style="width: 400px">
            <div class="modal-content" style="width: 400px">
                ...
                <div class="modal-body">
                    <div class="row" style="width: 100%">
                        <div class="col-8">
                            <i class="fas fa-exclamation-triangle" id="InApprWgTagWarning" style="color: darkorange; display: none;"></i><span class="textcss" style="color: black; font-weight: bold; font-size: 14px; padding-left: 12px;">CREATE TAG</span>
                        </div>
                        <%--<div class="col-sm-4" style="text-align: right">
                    ...
                    <div class="row">
                        <div class="col-9" style="padding-left: 30px; height: 25px;">
                            ...
                            <label id="lblCreateWgTagErrorMessage" style="display: block; color: red; font-family: Roboto, sans-serif; font-weight: normal; padding-top: 4px; padding-left: 5px;"></label>
            ...
            <div class="modal-content" style="width: 400px">
                ...
                <div class="modal-body">
                    <div class="row" style="width: 100%; padding-left: 10px">
                        <div class="col-6">
                            <span class="textcss" style="color: black; font-weight: bold; font-size: 14px;">OPT OUT</span>
                        </div>
                        <%--<div class="col-sm-6" style="text-align: right">
        ...
        <div class="modal-dialog" role="document" style="width: 400px">
            <div class="modal-content" style="width: 400px">
                ...
                <div class="modal-body">
                    <div class="row" style="width: 100%">
                        <div class="col-6">
                            <i class="fas fa-exclamation-triangle" id="InRenameTagApprWarning" style="color: darkorange; display: none;"></i><span class="textcss" style="color: black; font-weight: bold; font-size: 14px; padding-left: 12px;">RENAME TAG</span>
                        </div>
                        <%--<div class="col-sm-6" style="text-align: right">
                    ...
                    <div class="row">
                        <div class="col-9" style="padding-left: 30px; height: 30px;">
                            ...
                            <label id="lblRenameTagErrorMessage" style="color: red; font-family: Roboto, sans-serif; font-weight: normal; display: block; padding-top: 4px; padding-left: 5px;"></label>
        ...
        <div class="modal-dialog" role="document" style="width: 400px">
            <div class="modal-content" style="width: 400px">
                ...
                <div class="modal-body">
                    <div class="row" style="width: 100%">
                        <div class="col-6">
                            <span class="textcss" style="color: black; font-weight: bold; font-size: 14px;">&nbsp;DELETE TAG</span>
                        </div>
                        <%--<div class="col-sm-6" style="text-align: right">
        ...
        <div class="modal-dialog" role="document" style="width: 600px; right: 100px;">
            <div class="modal-content" style="width: 500px;">
                ...
                <div class="modal-body">
                    <div class="row" style="width: 100%;">
                        <div class="col-8">
                            <i class="fas fa-exclamation-triangle" id="DeleteWarning2nd" style="color: #FF8C00;"></i><span class="textcss" style="color: black; font-weight: bold; font-size: 14px;">&nbsp; DELETE TAG</span>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div id="tagdefinition" class="messagepop shadow-sm mb-5 bg-white tagDefPopup" style="border-radius: 5px; display: none; width: 335px;">
                        <div class="row tagDefPopup">
                            <div class="col-10 tagDefPopup" style="font-family: Roboto,sans-serif; font-size: 14px; font-weight: bold; padding-top: 5px; padding-left: 24px; padding-bottom: 10px;">Tag Definition</div>
                            <div class="col-2 tagDefPopup" style="float: right">
                                <button type="button" class="close" aria-label="Close" onclick="javascript:closeTagDefinition();">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                        </div>
    ...
    <script>
        ...
        function GenerateReport(wgId) {
            $('#exportText' + wgId).hide();
            $('#exportexcelimg' + wgId).attr('disabled', 'disabled');
            $('#exportwordimg' + wgId).attr('disabled', 'disabled');
            //$('#exportexcelimg' + wgId).removeClass('exportbutton').addClass('disabledexportbutton');
            $('#spinnerExport' + wgId).removeClass('d-none');
            var groupName = $('#Group' + wgId).attr('groupName');
            $.ajax({
                url: 'TagManagement.aspx/GenerateReport?wgId=' + wgId,
                type: 'POST',
                data: '{wgId: "' + wgId + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data, status, jqXHR) {
                    var fileName = groupName + '_Tag_Report_' + new Date().toLocaleDateString().replaceAll('/', '') + '.xlsx';
                    ...
                    $('#exportText' + wgId).show();
                    $('#exportexcelimg' + wgId).removeAttr('disabled');
                    $('#exportwordimg' + wgId).removeAttr('disabled');
                    //$('#exportexcelimg' + wgId).removeClass('disabledexportbutton').addClass('exportbutton');
                    $('#spinnerExport' + wgId).addClass('d-none');
                },
                error: function (jqXHR, status, error) {
                    $('#toastError').html('There was an error generating your report, please contact VACOASDTRMOPS@va.gov for assistance.');
        ...
        function viewTRMEntriesModel(showGrp, aTagId, aWID, groupName, isReopen) {
            ...
            var tagtype = $('#btn' + aTagId).attr('tagtype');
            var tagdef = $('#btn' + aTagId).attr('tagdef');
                        ...
                        if (data.d.lstTools != null) {
                            ...
                            if (showGrp) {
                                if (tagtype == "GLOBAL") {
                                    if (tagdef == "null" || tagdef == " " || tagdef == null) {
                                        $('#spanTaggedTagName').html('  Global Tag - ' + $('#ContentPlaceHolder1_selectedTagName').val());
                                    }
                                    else {
                                        $('#spanTaggedTagName').html('  Global Tag - ' + $('#ContentPlaceHolder1_selectedTagName').val() + '<i tgdefinition = "' + tagdef + '" class="fa fa-info-circle tagDef" style="padding-left:7px;cursor:pointer;font-size:12px;"></i>');
                                    }
                                }
                                else {
                                    $('#spanTaggedTagName').html('  Group Tag - ' + $('#ContentPlaceHolder1_selectedTagName').val());
                                }
                            }
                            else {
                                $('#spanTaggedTagName').html(' Personal Tag - ' + $('#ContentPlaceHolder1_selectedTagName').val());
                            }
                            ...
                            $('.fa-info-circle').click(function () {
                                if ($('#tagdefinition').is(':visible')) {
                                    ...
                                    var top = $('#tagdefinition').offset().top + 190;
                                    var left = $('#tagdefinition').offset().left + 130;
                ...
                success: function (data, status, jqXHR) {
                    ...
                    if (data != null) {
                        if (!data.d.IsValid) {
                            ...
                            $("#deleteTagModel").modal('hide');
                            if ($('#ContentPlaceHolder1_hdnSelectedWGId').val() == '-1') {
                                $('#toastSuccess').text('Tag deleted successfully.');
                                $('#goodToast').toast('show').show().delay(3000).fadeOut();
                                closeTagModel();
                            }
                            else {
        ...
        function downloadDocument(wgId, docType) {
            $('#exportText' + wgId).hide();
            $('#exportwordimg' + wgId).attr('disabled', 'disabled');
            //$('#exportexcelimg' + wgId).removeClass('exportbutton').addClass('disabledexportbutton');
            $('#spinnerExport' + wgId).removeClass('d-none');
            ...
            var wgLabel = $('#Group' + wgId).attr('groupName');
            var url = $('#hdnserverPath').val() + 'TagManagement.aspx?fileType=' + dtype + '&groupId=' + wgId + '&groupName=' + wgLabel + '';
        ...
        function getAllUserWorkGroups() {
                    ...
                    if (data != null) {
                        if (data.d.IsValid) {
                            ...
                            $.each(lstWgs, function (key, val) {
                                ...
                                var worddoctype = 'Word';
                                var spinnerId = 'spinnerExport' + wgId;
                                var exportexcelimgId = 'exportexcelimg' + wgId
                                var exportwordimgId = 'exportwordimg' + wgId
                                ...
                                parentDiv += '<div class="row"><div class="col-1" style="display:inline-block"> '
                                //if (u.Role == '1') {
                                ...
                                parentDiv += '<div class="col-7" style="padding-top:3px;display:inline-block;vertical-align: middle;font-family: Roboto, sans-serif;font-size:12px;color: #283154;font-weight:bold;padding-left:0px;white-space: pre-wrap;">'
                                $('#hdnserverPath').val('<%= serverPath %>');
                                parentDiv += val.WG_LABEL + '</div><div class="col-4 d-flex justify-content-end" style="vertical-align:bottom;font-family: Roboto, sans-serif;font-size:8px;margin-top:2px;display:inline-block;">'
                                parentDiv += '<span class="d-none  pull-right spinner-border spinner-border-sm" Id=' + spinnerId + ' role="status" aria-hidden="true"></span>&nbsp;&nbsp;<span id="exportText' + wgId + '">&nbsp;Export To:&nbsp;</span>'
                                parentDiv += '<button Id=' + exportexcelimgId + ' class="exportbutton" onclick="javascript:GenerateReport(' + wgId + ');">'
                                parentDiv += '<img align="right" src="images/excel.png" width="18" height="18" alt="generate excel file"/></button>'                               
                                parentDiv += '<button type="button" Id=' + exportwordimgId + ' class="exportbutton" onclick="downloadDocument(' + wgId + ',1); ">'
                                parentDiv += '<img align="right" class="HelpImage" src="images/word.png" width="18" height="18" alt="generate word file"/></button></div> '
                            ...
                            $.each(templstAllTags, function (key, val) {
                                ...
                                if (wgId == val.WG_ID) {
                                    ...
                                    if (record != undefined) {
                                        ...
                                        tagsdiv += '&nbsp;<div RoleId=' + u.Role + ' Id=' + btnId + ' wgId=' + val.WG_ID + ' tagId=' + val.TAG_ID + ' tagName="' + val.TAG_LABEL + '" groupName="' + groupName + '" entryCount="' + val.EntryCount + '" tagtype="' + val.TAG_TYPE + '" tagdef="' + val.TAG_DEFINITION + '" class="tagellipsisbutton"  style="height:100%;width:7px;float:left;cursor:pointer;padding-left:6px;padding-right:10px;padding-top:5px;"><i class="fas fa-ellipsis-v tag" style="color: #757575;cursor:pointer;"></i></div>'
                                        tagsdiv += '<div id="daTagName"' + val.TAG_ID + ' style="height:100%;float:left;padding-right:10px;padding-top:6px;padding-left:0px;font-size:11px;font-family: Roboto, sans-serif;font-weight:border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick="javascript:viewTRMEntriesModel(' + true + ',' + val.TAG_ID + ',' + val.WG_ID + ',\'' + groupName + '\');return false;"><i '
                                        if (val.TAG_TYPE == "GLOBAL") {
                                            tagsdiv += 'class="fas fa-globe"'
                                        }
                                        else {
                                            tagsdiv += 'class="fas fa-user-friends"'
                                        }
                                        tagsdiv += ' style = "padding-top:3px;padding-right:2px;float:left;" ></i > ' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div ></div ></div ></div > ';
                                        counter++;
                                    }
                                }
                            });
            ...
            $('.CustomButtons').click(function () {
                ...
                let show = true;
                if (btnid == $('#ContentPlaceHolder1_hdnSelectedWGId').val()) {
                ...
                if (btnid != $('#ContentPlaceHolder1_hdnSelectedWGId').val() ||
                    (btnid == $('#ContentPlaceHolder1_hdnSelectedWGId').val() && show)) {
            ...
            $('.tagellipsisbutton').click(function () {
                ...
                if (btnid != $('#ContentPlaceHolder1_selectedTagId').val() ||
                    ...
                    var tagtype = $('#btn' + btnid).attr('tagtype');
        ...
        $(document).ready(function () {
            ...
            $('#txtDeleteTagName2nd').keypress(function (event) {
            ...
            $("#txtRenameTagName").on('keydown keyup change', function (e) {
                var k = e.keyCode || e.which;
                let errorText = $('#lblRenameTagErrorMessage').html();
                ...
                if (charLength > 0 && trimLength == 0 && charLength <= maxLength) {
                    ...
                    errorText = "Name must include visible characters";
                    $('#lblRenameTagErrorMessage').html(errorText);
                    $('#renameTagcharcounter').text(charLength + '/' + maxLength);
                    return;
                }
                else if (charLength == 0) {
    ...
    <script>
        ...
        function showVideoModal(videoURL, videoTitle, linkShortDetail, linkFullDetail) {
            ...
            document.getElementById('videoText').innerHTML = linkFullDetail;
            document.getElementById('video').src = videoURL;
            document.getElementById('videoText').style.display = "inline";
            $("#videoModal").modal('show');
            document.getElementById('videoDesc').scrollTop = 0;
            document.getElementById('streamURL').innerHTML = videoURL;
        }
        ...
        $("#videoModal").on('keydown keyup change', function (e) {
            // ESCAPE key pressed                
            if ((e.keyCode || e.which) == 27) {
                document.getElementById('video').src = "";
                $("#videoModal").modal('hide');
