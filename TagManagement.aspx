...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function deleteTagModel2nd() {
            $("#txtDeleteTagName2nd").val("");
            $('#deletetagpopuptext2nd').html("Type the name <q><b>" + $('#ContentPlaceHolder1_selectedTagName').val() + "</b></q> above to confirm your request to delete the <b>" + $('#ContentPlaceHolder1_selectedTagName').val() + "</b>.  Once you press Delete, the tag cannot be recovered.");
