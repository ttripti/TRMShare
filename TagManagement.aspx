...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function closeviewTRMModel() {
            ...
            if ($('#btnOkTaggedEntires:disabled').length == 0 && $('#btnOkTaggedEntires').text() != 'OK') {
                    ...
                    if (data != null) {
                        ...
                        if (data.d.lstTools != null) {
                            ...
                            $.each(data.d.lstTools, function (key, val) {
                                ...
                                parentDiv += '<a href="#" OnClick="javascript:openToolPage(' + val.Tool_Id + ');return false;" style="color:#4169e1;font-family: Roboto;font-size:12px;">' + val.Tool_Name + '</a>';
                                if (RoleId < 3) {
                                    parentDiv += '</label>'
                                }
                                parentDiv += '</div>';
                ...
                success: function (data, status, jqXHR) {
                    ...
                    if (data != null) {
                        if (!data.d.IsValid) {
                            ...
                            $('#lblSuccessMessage').show().delay(3000).hide("slow");
                        }
                    }
                },
                error: function (jqXHR, status, error) {
