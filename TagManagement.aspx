        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 400px">
                ...
                <div class="modal-body">
                    <i class="fas fa-exclamation-triangle" style="color: darkorange; font-size: 24px;" color="#FF8C00"></i>
                    <span class="textcss" style="color: black; font-weight: bold; font-size: 16px;">&nbsp;GROUP NAME EXISTS</span>
                    <p></p>
                    You previously created the group <span id="spanDupGroup" style="font-family: Roboto, sans-serif; font-size: 14px; font-weight: bold; color: black"></span> which still exists with active members. Would you like to create it anyway or go back to change the name of this new group?
                    <p></p>
                </div>
                    ...
                    if (data != null) {
                        ...
                        if (data.d.lstTools != null) {                           
                           ...
                           $.each(data.d.lstTools, function (key, val) {
                               ...
                               parentDiv += '<a href="#" onclick="javascript:openToolPage(' + val.Tool_Id + ');return false;" class="daLink" style="color:#4169e1;font-family: Roboto;font-size:12px;">' + val.Tool_Name + '</a>';
