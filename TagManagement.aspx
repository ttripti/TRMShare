...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div  class="row">
        <div class="col-12" style="font-weight: 500; font-family: 'Roboto', sans-serif; font-size: 11px;">
           <i class="fa fa-video" style="padding : 0px 0px 0px 0px;"></i>&nbsp;&nbsp;<a style="padding : 0px 0px 0px 0px;" href="TRMHomePage.aspx" target="_blank">How to use Tag Management in TRM</a>
        </div>
    </div>
    <div style="max-width:60%;">  
        <p style="font-size:11px;font-family: Arial;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.Nunc porttitor maximus laoreet. Pellentesque habitant morbi tristique senectus et netus et 
        <span id="dots">...&nbsp;</span>
        <span id="more">netus et malesuada fames ac turpis egestas. In hac habitasse platea dictumst.
                 Suspendisse venenatis sollicitudin erat in gravida. Sed eget nisl tristique, commodo lectus
                 sit amet, vulputate sem. Cras porttitor lorem ipsum, sit amet iaculis massa feugiat vitae.
                 Curabitur sapien odio, ullamcorper tincidunt interdum vitae, vestibulum eu neque. Nam leo massa,
                 fringilla eget mauris feugiat, auctor suscipit justo.</span>
            ...
            <tr style="border-bottom: 0.5pt solid lightgrey;">
                <td>
                    <div id="dvPersonalTag">
                        ...
                        <div class="tagMgntVideoLinks" style="padding-top:7px;padding-bottom:7px;">
                           <i class="fa fa-video"></i>&nbsp;&nbsp;<a href="TRMHomePage.aspx" target="_blank">How to - Personal Tags</a>
                        </div>
                        <div class="row">
                            <div class="col-12">
                ...
                <td>
                    <div id="dvTagGroups">
                        ...
                        <button id="btnnewgroup" class="ptnewtagbutton" onclick="javascript:OpenNewGroupDialog();return false;">
                         ...
                         <div class="tagMgntVideoLinks" style="padding-top:7px;">
                           <i class="fa fa-video"></i>&nbsp;&nbsp;<a href="TRMHomePage.aspx" target="_blank">How to - Group Tags</a>
                        </div>
    ...
    <script>
                    ...
                    if (data != null) {
                        ...
                        if (data.d.IsValid) {
                            ...
                            $.each(lstTags, function (key, val) {
                                ...
                                var aNull = null;
                                parentDiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div Id=' + dvId + ' style="display:inline-block;background-color:rgb(220, 230, 250);border-radius:2px;padding-bottom:5px;" ><div style="font-size:12px;display:inline-block;border-radius:6px;">'
                                parentDiv += '&nbsp;<div Id=' + btnId + ' tagId=' + val.TAG_ID + ' tagName="' + val.TAG_LABEL + '" class="tagellipsisbuttonpt"  style="width:7px;display: inline-block;cursor:pointer;"><i class="fas fa-ellipsis-v tag" style="color: #757575;cursor:pointer;"></i></div>'
                                parentDiv += '<div style="display: inline-block;padding-right:10px;font-size:11px;font-family: Roboto, sans-serif;font-weight:border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick="javascript:viewTRMEntriesModel(' + false + ',' + val.TAG_ID + ',' + aNull + ',null);return false;">&nbsp;&nbsp;<i class="fas fa-user"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
                                counter++;
                    ...
                    if (data != null) {
                        if (data.d.IsValid) {
                            ...
                            $.each(lstWgs, function (key, val) {
                                ...
                                var u = lstAllWgMembers.find(m => m.WG_ID == wgId );
                                ...
                                $.each(lstAllWgTags, function (key, val) {
                                    ...
                                    if (wgId == val.WG_ID) {
                                        ...
                                        if (record != undefined) {
                                            tagsdiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div Id=' + dvId + ' style="display:inline-block;background-color:rgb(220, 230, 250);border-radius:2px;padding-bottom:5px;" ><div style="font-size:12px;display:inline-block;border-radius:6px;">'
                                            tagsdiv += '&nbsp;<div RoleId=' + u.Role + ' Id=' + btnId + ' wgId=' + val.WG_ID + ' tagId=' + val.TAG_ID + ' tagName="' + val.TAG_LABEL + '" groupName="' + groupName + '" class="tagellipsisbutton"  style="width:7px;display: inline-block;cursor:pointer;"><i class="fas fa-ellipsis-v tag" style="color: #757575;cursor:pointer;"></i></div>'
                                            tagsdiv += '<div style="display: inline-block;padding-right:10px;font-size:11px;font-family: Roboto, sans-serif;font-weight:border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick="javascript:viewTRMEntriesModel(' + true + ',' + val.TAG_ID + ',' + val.WG_ID + ',\'' + groupName + '\');return false;">&nbsp;&nbsp;<i class="fas fa-user-friends"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
                                            counter++;
                                        }
                                    }
                                });
                                ...
                                u1 = lstAllWgMembers.find(m => m.WG_ID == wgId );
        ...
        function refreshWorkGroupMembers(wgId, scrollPosition) {
            $.ajax({
                ...
                success: function (data, status, jqXHR) {
                    ...
                    tblmember += ' <div id="tabbody" style="width:100%;max-height:275px;overflow-y:auto;overflow-x:hidden"><table> ';
                    var selectId = '';
                    for (var i = 0; i < results.length; i++) {
                        ...
                        tblmember += '<td class="" style="font-family: Roboto;font-size:12px;width:26%;font-color:grey;padding-left:8px;"><select style="width:80%;font-family: Roboto;font-size:12px;border-bottom-width:3px;border-bottom-color:darkgrey;" onchange="javascript:roleChange(' + rec.TAG_MEMBER_ID + ')" class="form-select form-select roleoption" id="' + selectId + '">';
                        ...
                        tblmember += '</select>'
                        tblmember += '<td class="" style="font-family: Roboto;font-size:12px;width:4%;padding-left:8px;"><div id="clickableDisabledTrash"></div><button style="border-width:0px;background-color:white;" onClick="javascript:deleteTagMember(' + rec.TAG_MEMBER_ID + ',' + wgId + ');return false;" id="LockButton" class="fas fa-trash"> </button></td>';
                        tblmember += '</tr>'
                    ...
                    $('#MembersModel .modal-dialog').css('right', '310px');
                    $('#btnValidate').attr('disabled', 'disabled');
                    $('#btnAddMember').attr('disabled', 'disabled');
        ...
        function displayRoleInfo() {
            ...
            if ($('#dvRolePopup').is(':visible')) {
                ...
                var btn1 = $('#tabhead');
                console.log('horizontal : ' + window.scrollX + ' vertical : ' + window.scrollY);
                console.log('doc horizontal : ' + $('#MembersModel').scrollLeft() + ' doc vertical : ' + $('#MembersModel').scrollTop());
               var top = (btn1.offset().top - window.scrollY) +123;
                //var top = (btn1.outerHeight()) + 380;
                var left = (btn1.offset().left - window.scrollX) + 280;
            ...
            $('#MembersModel').on('keydown', function (event) {
                if ((event.keyCode || event.which) == 27) { 
                    if ($('#dvRolePopup').is(':visible')) {
                        ...
                        //console.log($("#MembersModel").modal());
                       // $("#MembersModel").modal({ keyboard: true });
                        //$("#MembersModel").modal({ backdrop: true });
