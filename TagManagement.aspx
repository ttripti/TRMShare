...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id="tagManagementTable">
        <tr style="border-bottom:0.5pt solid lightgrey;"><td>
            <div id="dvPernonalTag" style="padding-bottom: 50px;padding-left: 10px;padding-right:20px">
                <div>
                    <br />
                </div>
                <div class="row">
            ...
            <td><div class="col-sm-4" style="font-weight: bold; font-family: 'Roboto', sans-serif; font-size: 17px">
                Personal Tag&nbsp;&nbsp;&nbsp;&nbsp;<%--</div>--%>
                <%--<div class="col-sm-11">--%>
                <button id="btnnewpersonaltag" class="newpersonaltagbutton" onclick="javascript:OpenNewGroupDialog();return false;">
                    <i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;NEW TAG
                </button>
                 
            </div></td>
                <td><a class="collapseClass" data-toggle="collapse"  href="#dvWGPersonalTagsContainer"><i class="fa fa-chevron-down"></i></a></td>
                </tr></table>
                 
            <div class="col-sm-8">
                <div id="dvPvtTagErrorMessage"></div>
                <span id="lblPvtTagSuccessMessage" style="font-family: 'Roboto', sans-serif; color: green;"></span>
            </div>
        </div>
        ...
        <tr style="border-bottom:0.5pt solid lightgrey;"><td>
            <div id="dvTagGroups" style="padding-bottom: 50px;padding-left: 10px;padding-right:20px">
            <div>
                <br />
            </div>
        <div class="row">
            ...
            <td><div class="col-sm-4" style="font-weight: bold; font-family: 'Roboto', sans-serif; font-size: 17px">
                My Groups&nbsp;&nbsp;&nbsp;&nbsp;<%--</div>--%>
                <%--<div class="col-sm-11">--%>
                <button id="btnnewgroup" class="newgroupbutton" onclick="javascript:OpenNewGroupDialog();return false;">
                    <i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;NEW GROUP
                </button>
                 
            </div></td>
                <td><a class="collapseClass" data-toggle="collapse"  href="#dvWGTagsContainer"><i class="fa fa-chevron-down"></i></a></td>
                </tr></table>
