...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="padding-top:5px;padding-left:10px;padding-right:10px;width:450px;">
                ...
                <div class="modal-body" style="padding-top:0px;padding-bottom:20px;">
                    ...
                    <span id="unsavedText" style="text-align:left;font-family: Roboto, sans-serif; font-size: 14px; color: black">
                    </span><br />
                    <p></p>
                </div>
            <div class="modal-footer" >
        ...
        <div class="modal-dialog membersDialog " role="document" style="width:825px;min-width: 825px !important;padding-right:15px !important;padding-left: 15px !important;">
            <div class="modal-content" style="width: 800px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row" style="width: 100%; padding-top: 20px;">
                        <div class="col-6">
                            <div id="dvemailaddressModel">
                                <div class="">
                                    ...
                                    <div id="dvEmailIdInfo" class=" shadow-sm mb-5 bg-white" style="border-radius:5px;font-family: 'Roboto', sans-serif; font-size: 10px;display: none; width: 405px;height:120px;">
                                          <div style="padding-bottom:15px;">
                                            <button type="button" class="close" aria-label="Close" style="font-family: 'Roboto', sans-serif; font-size: 14px;margin-right:10px;padding-top:10px;" onclick="javascript:closeEmailIdInfo();">
                                                        <span aria-hidden="true"> &times;</span>
                                            </button></div>
                                           <div style="font-family: 'Roboto', sans-serif; font-size: 12px;overflow-wrap:normal;padding-right:16px;padding-left:16px;padding-top:10px;">
                        ...
                        <div class="col-6" style="text-align: left;height:45px;padding-left:0px;">
                            ...
                            <div style="display: inline-block;vertical-align:middle" >
                                ...
                                <label id="lblErrorMessage" style="padding-top: 12px; color: red; font-family: Roboto; font-size: 10px; font-weight: normal;"></label>
                    ...
                    <div class="row" style="font-family: Roboto; font-size: 14px; font-weight: bold;padding-top:10px;">
                        <div class="col-12">
    ...
    <script>
        ...
        function closeviewTRMModel() {
            ...
            if ($('#btnOkTaggedEntires:disabled').length == 0 && !($('#burntToast').is(':visible'))) {
                $("#unsavedText").text("You have unsaved changes. Do you want to save or discard them ?");
        ...
        function createTagEntryModel() {
            ...
            $('#tagentryTitle').text('TAG TRM ENTRY');
            if (wgId >= 0) {
                $('#dvGroupEntry').show();
                $('#tagEntryGroupIcon').show();
                $('#tagentryGroupName').text('Group: ' + $('#Group' + wgId).attr('groupName'));
                $('#tagentryTagName').text('Tag: ' + $('#ContentPlaceHolder1_selectedTagName').val());
            }
            else {
                $('#dvGroupEntry').hide();
        ...
        function viewTRMEntriesModel(showGrp, aTagId, aWID, groupName, isReopen) {
            ...
            //confirm("RoleId-->" + RoleId + " -->" + $('#ContentPlaceHolder1_hdnLoggedInUserId').val() )
            if (RoleId < 3) {
                $('#btnOkTaggedEntires').text('APPLY');
                $('#btnOkTaggedEntires').show();
            } else {
                $('#btnOkTaggedEntires').text('OK');
                $('#btnOkTaggedEntires').show();
            }
                    ...
                    if (data != null) {
                        ...
                        if (data.d.lstTools != null) {
                            ...
                            $.each(data.d.lstTools, function (key, val) {
                                ...
                                numElements++;
                                parentDiv += '<div style="text-decoration: none;font-family: Roboto;font-size:11px;padding-left:30px;padding-bottom:5px;" class="form-check list-group-item list-group-item-action" id="' + val.TAG_ID + '" >';
                                if (RoleId < 3) {
                                ...
                                parentDiv += '<a href="#" OnClick="javascript:openToolPage(' + val.Tool_Id + ');return false;" style="text-decoration:none;color:#4169e1;font-family: Roboto;font-size:12px;">' + val.Tool_Name + '</a>';
                                if (RoleId < 3) {
                                    parentDiv += '</label>'
                                }
                                parentDiv += '</div>';
        ...
        function btnDoneChange() {
            ...
            if ($('#btnAddMember:disabled').length == 0 && !($('#burntToast').is(':visible'))) {
                                ...
                                $.each(templstAllTags, function (key, val) {
                                    ...
                                    if (wgId == val.WG_ID) {
                                        ...
                                        if (record != undefined) {
                                            ...
                                            tagsdiv += '&nbsp;<div RoleId=' + u.Role + ' Id=' + btnId + ' wgId=' + val.WG_ID + ' tagId=' + val.TAG_ID + ' tagName="' + val.TAG_LABEL + '" groupName="' + groupName + '" class="tagellipsisbutton"  style="width:7px;display: inline-block;cursor:pointer;padding-left:5px;padding-right:5px;padding-top:5px;"><i class="fas fa-ellipsis-v tag" style="color: #757575;cursor:pointer;"></i></div>'
                                            tagsdiv += '<div id="daTagName"' + val.TAG_ID + ' style="display: inline-block;padding-top:5px;padding-right:10px;font-size:11px;font-family: Roboto, sans-serif;font-weight:border-radius: 3px;white-space: pre-wrap;cursor:pointer" onclick="javascript:viewTRMEntriesModel(' + true + ',' + val.TAG_ID + ',' + val.WG_ID + ',\'' + groupName + '\');return false;">&nbsp;&nbsp;'
            ...
            $.ajax({
                ...
                error: function (jqXHR, status, error) {
                    ...
                    if (status == 'error') {
                        ...
                        //$('#toastError').text(email + ' is not a valid VA email address');
        ...
        function displayEmailIdInfo() {
            ...
            if ($('#dvEmailIdInfo').is(':visible')) {
                ...
                var top = (btn1.offset().top - (window.scrollY - modalTopScroll)) + 130;
                            ...
                            if (data != null) {
                                if (!data.d.IsValid) {
                                    ...
                                    if (data.d.IsPageRefresh) {
                                        $("#MembersModel").modal('hide');
                                        $('#toastSuccess').text(' Member removed.');
                                        $('#goodToast').toast('show').show().delay(3000).fadeOut();
                                        getAllUserWorkGroups();
                                    }
                                    else {
                ...
                success: function (data, status, jqXHR) {
                    ...
                    if (data != null) {
                        if (!data.d.IsValid) {
                            ...
                            getWGMembersById(wgId);
                            $('#toastSuccess').text(' Member added successfully.');
                            $('#goodToast').toast('show').show().delay(3000).fadeOut();
                        }
                    }
                },
