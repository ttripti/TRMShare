...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="font-weight: 600; font-family: 'Roboto', sans-serif; font-size: 17px; margin-top:5px">
                Tag Management</div>
    <div id="dvTags">
    <table id="tagManagementTable">
           ...
           <td>
            <div id="dvPersonalTag">
                ...
                <br />
                             ...
                             <div class="row">
                               <div class="col-4" style="font-weight: bold; font-family: 'Roboto', sans-serif; font-size: 17px">
                                        My Personal Tags (<span id="spanPersonalTotalTags"> </span>)
                                        <button id="btnnewpersonaltag" class="newtagbutton" onclick="javascript:openPsnlTagModel(0);return false;">
                              ...
                              <div class="row" style="padding-top: 20px;">
                                    <div class="col-12">
                                        <div class="collapse show row" id="dvWGPersonalTagsContainer">
                                    </div>
                              </div>
                            </div>
                    <div>
        ...
        <div class="row" >
            <div class="col-12" style="font-weight: bold; font-family: 'Roboto', sans-serif; font-size: 17px">
            ...
            <div class="col-4" id="GrpCollapse"><a aria-expanded="true" class="collapseClass" data-toggle="collapse"  href="#dvWGTagsContainer">
                <i class="fa fa-chevron-up"></i>
                <i class="fa fa-chevron-down"></i>
            </a>
             </div>                       
    ...
    <div class="modal fade" id="MembersModel" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="membersModalLabel" aria-hidden="true">
                    ...
                    if (data != null) {
                        ...
                        if (data.d.IsValid) {
                            ...
                            $.each(lstTags, function (key, val) {
                                ...
                                parentDiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div Id=' + dvId + ' style="display:inline-block;background-color:rgb(220, 230, 250);border-radius:2px;padding-bottom:2px;" ><div style="font-size:12px;display:inline-block;border-radius:6px;">'
                                ...
                                parentDiv += '<div style="display: inline-block;padding-right:10px;font-size:11px;font-family: Roboto, sans-serif;font-weight:border-radius: 3px;white-space: pre-wrap;">&nbsp;&nbsp;<i class="fas fa-user"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
                                counter++;
                            }); 
                            if (counter == 0) {
                                parentDiv += '<div style="display: nline-block;padding-left:30px;font-size:17px;font-family: Roboto, sans-serif;"><p>You have no personal tags.</p></div>'
                            }
                            parentDiv += '</div>';
                           // parentDiv += '</div>'
                    ...
                    if (data != null) {
                        if (data.d.IsValid) {
                            ...
                            $.each(lstWgs, function (key, val) {
                                ...
                                parentDiv += '<div class="row"><div class="col-7"><span style="font-family: Roboto;font-size:10px;font-weight:bold">&nbsp;&nbsp;TAGS</span></div><div class="col-5" style="padding-left:30px;">';
                                ...
                                var counter = 0;
                                parentDiv += '<div class="row" style="padding-top:5px;"><div class="col-12">'
                                $.each(lstAllWgTags, function (key, val) {
                                    ...
                                    if (wgId == val.WG_ID) {
                                        ...
                                        if (record != undefined) {
                                            parentDiv += '<div style="display:inline-block;padding:4px 4px 4px 4px;"><div Id=' + dvId + ' style="display:inline-block;background-color:rgb(220, 230, 250);border-radius:2px;padding-bottom:1px;" ><div style="font-size:12px;display:inline-block;border-radius:6px;">'
                                            ...
                                            parentDiv += '<div style="display: inline-block;padding-right:10px;font-size:11px;font-family: Roboto, sans-serif;font-weight:border-radius: 3px;white-space: pre-wrap;">&nbsp;&nbsp;<i class="fas fa-user-friends"></i>&nbsp;&nbsp;' + val.TAG_LABEL + ' (' + val.EntryCount + ')' + '</div></div></div></div>';
                                            counter++;
                                        }
                                    }
                                });
                            ...
                            if (WorkGroupCounter == 0) {
                                parentDiv += '<div style="display: nline-block;padding-left:30px;font-size:17px;font-family: Roboto, sans-serif;"><p>You are not a member of any groups.</p></div>'
                            }
                            ...
                            $('.tagellipsisbutton').click(function () {
                                ...
                                if ($('#dvTagPopup').is(':visible')) {
                                    ...
                                    var btn1 = $(this);
                                    $('.tagpop').css('position', 'absolute');
                                    var top = btn1.offset().top + btn1.outerHeight() + 1;
                                    var left = btn1.offset().left - 3;
        ...
        function refreshWorkGroupMembers(wgId) {
            $.ajax({
                ...
                success: function (data, status, jqXHR) {
                    ...
                    tblmember += ' <div id="tabbody" style="width:100%;max-height:135px;overflow-y:auto;overflow-x:hidden"><table> ';
                    var selectId = '';
                    for (var i = 0; i < results.length; i++) {
                        ...
                        tblmember += '</select>'
                        tblmember += '<td class="" style="font-family: Roboto;font-size:12px;width:4%;padding-left:8px;"><button style="border-width:0px;background-color:white;" onClick="javascript:deleteTagMember(' + rec.TAG_MEMBER_ID + ',' + wgId + ');return false;" id="LockButton" class="fas fa-trash"> </button></td>';
                        tblmember += '</tr>'
