...
this.firstFormGroup =this._formBuilder.group({
  ...
  ProjectName:['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]],
  VASIID:['',[Validators.required,Validators.pattern('^[0-9]*$')] ],
  Date:['', Validators.required],
  OrgName:['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]],
  ReqRole:['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]],
  SystemName:['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]],
  SystemOwner:['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]],
  ISO:['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]]
});

this.secondFormGroup =this._formBuilder.group({
  ReqPurpose :['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]],
  ReqWhatValueToAnticipate:['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]],
  ReqHowManyTech:['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]],
  ReqHowPlannedUsage:['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]],
  ReqWillOtherTeams:['', Validators.required],
  ReqWhichTeams:['', [Validators.required,Validators.pattern(this.getEmojiRegEx())]],
