...
get ProjectName(){
  return this.firstFormGroup.get('ProjectName')
}
get OrgName(){
  return this.firstFormGroup.get('OrgName')
}
get ReqRole(){
  return this.firstFormGroup.get('ReqRole')
}
get SystemName(){
  return this.firstFormGroup.get('SystemName')
}
get SystemOwner(){
  return this.firstFormGroup.get('SystemOwner')
}
get ISO(){
  return this.firstFormGroup.get('ISO')
}
get ReqPurpose(){
  return this.secondFormGroup.get('ReqPurpose')
}
get ReqWhatValueToAnticipate(){
  return this.secondFormGroup.get('ReqWhatValueToAnticipate')
}
get ReqHowManyTech(){
  return this.secondFormGroup.get('ReqHowManyTech')
}
get ReqHowPlannedUsage(){
  return this.secondFormGroup.get('ReqHowPlannedUsage')
}
get ReqWhichTeams(){
  return this.secondFormGroup.get('ReqWhichTeams')
}

isReqWhatValueToAnticipateValid() : boolean{
  if(this.ReqWhatValueToAnticipate.invalid && this.ReqWhatValueToAnticipate.getRawValue()!='')
{
  return false;
}
else
...
this.firstFormGroup =this._formBuilder.group({
  ReqName :['', [Validators.required,this.noWhitespaceValidator]],
  ReqVAEmail:['',[ Validators.required,this.noWhitespaceValidator]],
  ReqPhoneNo:['', [Validators.required,this.noWhitespaceValidator]],
  ProjectName:['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]],
  VASIID:['',[Validators.required,Validators.pattern('^[0-9]*$'),this.noWhitespaceValidator] ],
  Date:['', [Validators.required,this.noWhitespaceValidator]],
  OrgName:['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]],
  ReqRole:['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]],
  SystemName:['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]],
  SystemOwner:['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]],
  ISO:['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]]
});

this.secondFormGroup =this._formBuilder.group({
  ReqPurpose :['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]],
  ReqWhatValueToAnticipate:['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]],
  ReqHowManyTech:['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]],
  ReqHowPlannedUsage:['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]],
  ReqWillOtherTeams:['',[ Validators.required,this.noWhitespaceValidator]],
  ReqWhichTeams:['', [Validators.required,Validators.pattern(this.getEmojiRegEx()),this.noWhitespaceValidator]],
...
toggleShown(hideORshow: boolean) {
 ...
 if(hideORshow==true)
 {
  ...
  console.log("hideOrShow firstDIV: "+this.showDiv1+ " secondDIV: "+this.showDiv2 + " this.fileUpload.nativeElement.value " + this.fileUpload.nativeElement.value);
}

validateInputFields(fieldName, event):any{
  if(fieldName =='ProjectName'){
    this.firstFormGroup.get('ProjectName').markAsTouched();
    this.thirdFormGroup.get('ProjectName').markAsTouched();
    if(this.firstFormGroup.get('ProjectName').invalid==true)
    {
      this.firstFormGroup.get('ProjectName').invalid==true;   
    }
    else if (this.thirdFormGroup.get('ProjectName').invalid==true)
    {
      this.thirdFormGroup.get('ProjectName').invalid==true;   
    }
  }
  else if(fieldName =='OrgName'){
    this.firstFormGroup.get('OrgName').markAsTouched();
    this.thirdFormGroup.get('OrgName').markAsTouched();
    if(this.firstFormGroup.get('OrgName').invalid==true)
    {
      this.firstFormGroup.get('OrgName').invalid==true;   
    }
    else if (this.thirdFormGroup.get('OrgName').invalid==true)
    {
      this.thirdFormGroup.get('OrgName').invalid==true;   
    }
  }
  else if(fieldName =='ReqRole'){
    this.firstFormGroup.get('ReqRole').markAsTouched();
    this.thirdFormGroup.get('ReqRole').markAsTouched();
    if(this.firstFormGroup.get('ReqRole').invalid==true)
    {
      this.firstFormGroup.get('ReqRole').invalid==true;   
    }
    else if (this.thirdFormGroup.get('ReqRole').invalid==true)
    {
      this.thirdFormGroup.get('ReqRole').invalid==true;   
    }
  }
  else if(fieldName =='SystemName'){
    this.firstFormGroup.get('SystemName').markAsTouched();
    this.thirdFormGroup.get('SystemName').markAsTouched();
    if(this.firstFormGroup.get('SystemName').invalid==true)
    {
      this.firstFormGroup.get('SystemName').invalid==true;   
    }
    else if (this.thirdFormGroup.get('SystemName').invalid==true)
    {
      this.thirdFormGroup.get('SystemName').invalid==true;   
    }
  }
  else if(fieldName =='SystemOwner'){
    this.firstFormGroup.get('SystemOwner').markAsTouched();
    this.thirdFormGroup.get('SystemOwner').markAsTouched();
    if(this.firstFormGroup.get('SystemOwner').invalid==true)
    {
      this.firstFormGroup.get('SystemOwner').invalid==true;   
    }
    else if (this.thirdFormGroup.get('SystemOwner').invalid==true)
    {
      this.thirdFormGroup.get('SystemOwner').invalid==true;   
    }
  }
  else if(fieldName =='ISO'){
    this.firstFormGroup.get('ISO').markAsTouched();
    this.thirdFormGroup.get('ISO').markAsTouched();
    if(this.firstFormGroup.get('ISO').invalid==true)
    {
      this.firstFormGroup.get('ISO').invalid==true;   
    }
    else if (this.thirdFormGroup.get('ISO').invalid==true)
    {
      this.thirdFormGroup.get('ISO').invalid==true;   
    }
  }
  else if(fieldName =='ReqPurpose'){
    this.secondFormGroup.get('ReqPurpose').markAsTouched();
    this.thirdFormGroup.get('ReqPurpose').markAsTouched();
    if(this.secondFormGroup.get('ReqPurpose').invalid==true)
    {
      this.secondFormGroup.get('ReqPurpose').invalid==true;   
    }
    else if (this.thirdFormGroup.get('ReqPurpose').invalid==true)
    {
      this.thirdFormGroup.get('ReqPurpose').invalid==true;   
    }
  }
  else if(fieldName =='ReqWhatValueToAnticipate'){
    this.secondFormGroup.get('ReqWhatValueToAnticipate').markAsTouched();
    this.thirdFormGroup.get('ReqWhatValueToAnticipate').markAsTouched();
    if(this.secondFormGroup.get('ReqWhatValueToAnticipate').invalid==true)
    {
      this.secondFormGroup.get('ReqWhatValueToAnticipate').invalid==true;   
    }
    else if (this.thirdFormGroup.get('ReqWhatValueToAnticipate').invalid==true)
    {
      this.thirdFormGroup.get('ReqWhatValueToAnticipate').invalid==true;   
    }
  }
  else if(fieldName =='ReqHowManyTech'){
    this.secondFormGroup.get('ReqHowManyTech').markAsTouched();
    this.thirdFormGroup.get('ReqHowManyTech').markAsTouched();
    if(this.secondFormGroup.get('ReqHowManyTech').invalid==true)
    {
      this.secondFormGroup.get('ReqHowManyTech').invalid==true;   
    }
    else if (this.thirdFormGroup.get('ReqHowManyTech').invalid==true)
    {
      this.thirdFormGroup.get('ReqHowManyTech').invalid==true;   
    }
  }
  else if(fieldName =='ReqHowPlannedUsage'){
    this.secondFormGroup.get('ReqHowPlannedUsage').markAsTouched();
    this.thirdFormGroup.get('ReqHowPlannedUsage').markAsTouched();
    if(this.secondFormGroup.get('ReqHowPlannedUsage').invalid==true)
    {
      this.secondFormGroup.get('ReqHowPlannedUsage').invalid==true;   
    }
    else if (this.thirdFormGroup.get('ReqHowPlannedUsage').invalid==true)
    {
      this.thirdFormGroup.get('ReqHowPlannedUsage').invalid==true;   
    }
  }
  else if(fieldName =='ReqWhichTeams'){
    this.secondFormGroup.get('ReqWhichTeams').markAsTouched();
    this.thirdFormGroup.get('ReqWhichTeams').markAsTouched();
    if(this.secondFormGroup.get('ReqWhichTeams').invalid==true)
    {
      this.secondFormGroup.get('ReqWhichTeams').invalid==true;   
    }
    else if (this.thirdFormGroup.get('ReqWhichTeams').invalid==true)
    {
      this.thirdFormGroup.get('ReqWhichTeams').invalid==true;   
    }
  }
}
...
submit():void {
  ...
  this._reqApiService.saveAPIRequest(formData).subscribe((resp:any)=> {
      if(resp.status =='success')
      {
        ...
        this._snackbar.open('There is an error on the form.','X');
      }
  });
}
...
if(selectedvalue=="1") {
  ...
  this.secondFormGroup.get('ReqWhichTeams').setValidators([Validators.required,Validators.pattern(this.getEmojiRegEx())]);
  this.thirdFormGroup.get('ReqWhichTeams').setValidators([Validators.required,Validators.pattern(this.getEmojiRegEx())]);
...
else
{
  ...
  isDragDrop = false;
  onFileClick():void {
    console.log("File size now : " + this.allFiles.length );
    let alreadyFileExists = false;
    if(this.allFiles.length > 0)
      alreadyFileExists = true;
      //Commented for UAT issue - reopening file browser should not clear the previous selected file
   // this.allFiles =[];
